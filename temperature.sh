...
if [ ! -f $FILENAME ]
then
    echo "Date;Time;AirIn;AirOut;FloorIn;FloorOut;SolarUp;SolarDown" > $FILENAME
fi
...
echo "$DATETIME;$TEMP_AIR_IN;$TEMP_AIR_OUT;$TEMP_FLOOR_IN;$TEMP_FLOOR_OUT;$TEMP_SOL_UP;$TEMP_SOL_DOWN;$TEMP_WARM_WATER" >> $FILENAME
